...
surface(x,y,transpose(squeeze(tauOpt_ftn1m(ic,1,:,:))),'EdgeColor','none')
set(gca,'FontName','Times','FontSize',pfnt,'TickLength',[0.02,0.02],...
    'Box','on','Layer','top','XTick',tick,'YTick',tick)
if (j~=0)
    set(gca,'XTickLabel',{})
...
surface(x,y,transpose(squeeze(tauEst_fln1m(ic,1,:,:))),'EdgeColor','none')
set(gca,'FontName','Times','FontSize',pfnt,'TickLength',[0.02,0.02],...
    'Box','on','Layer','top','XTick',tick,'YTick',tick)
if (j~=0)
    set(gca,'XTickLabel',{})
...
print(gcf,'-r600','-dpng',[fdir 'stress_ic' num2str(ic) '.png'])
